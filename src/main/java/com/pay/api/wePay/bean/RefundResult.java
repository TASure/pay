...
public class RefundResult {
	...
	private Integer coupon_refund_fee;// 代金券退款金额

	private Integer coupon_refund_count;// 退款代金券使用数量

	private String coupon_refund_batch_id_$n_$m;// 退款代金券批次ID

	private String coupon_refund_id_$n_$m;// 退款代金券ID

	private Integer coupon_refund_fee_$n_$m;// 单个退款代金券支付金额
